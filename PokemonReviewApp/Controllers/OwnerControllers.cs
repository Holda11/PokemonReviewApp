...
namespace PokemonReviewApp.Controllers
{
    ...
    [ApiController]
    public class OwnerControllers : Controller
    {
        private readonly IOwnerRepository _ownerRepository;
        private readonly ICountryRepository _countryRepository;
        private readonly IMapper _mapper;

        public OwnerControllers(IOwnerRepository ownerRepository, ICountryRepository countryRepository, IMapper mapper)
        {
        ...
        public IActionResult DeleteOwner(int ownerId)
        {
            ...
            {
                ModelState.AddModelError("", "Something went Wrong with Delete");
            }
            return NoContent();
        }
